...
Find below a list of  `wealthfreed` commands added with the  `x/revenue` module. You can obtain the full list by using the `wealthfreed -h` command. A CLI command can look like this:

```bash
wealthfreed query revenue params
```
