...
MY_VALIDATOR_ADDRESS=$(wealthfreed keys show dev0 -a)
```
...
yes $KEYPASSWD | wealthfreed keys add me
yes $KEYPASSWD | wealthfreed keys show me
# start wealthfreed with keyring-backend flag
wealthfreed --keyring-backend=file start
```
