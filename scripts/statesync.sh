...
# Initialize chain.
wealthfreed init test --chain-id evmos_9000-2

# Get Genesis
wget https://archive.evmos.org/mainnet/genesis.json
mv genesis.json ~/.wealthfreed/config/

wget -O ~/.wealthfreed/config/adrbook.json https://snapshot.notional.ventures/evmos/addrbook.json
...
export wealthfreed_P2P_MAX_NUM_INBOUND_PEERS=200
export wealthfreed_P2P_MAX_NUM_OUTBOUND_PEERS=200
export wealthfreed_STATESYNC_RPC_SERVERS="https://evmos-rpc.polkachu.com:443,https://rpc-evmos-ia.notional.ventures:443"
