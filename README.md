...
wealthfreed tx staking create-validator --from <VALIDATOR_KEY> --moniker thomas --pubkey $(wealthfreed tendermint show-validator) --chain-id <MAINNODE_CHAIN_ID> --keyring-backend test --amount 1wfl --commission-max-change-rate 0.01 --commission-max-rate 0.2 --commission-rate 0.1 --min-self-delegation 1 --fees 20000awfl -b block --gas auto